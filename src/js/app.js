...
$(".ref_click").on("click", function (e) {
  $("#get_ref_here").show();

});

      $("#menu_9_desktop").on("click", function () {

        $("#get_ref_here").show();

      });

      $("#closeRef_desktop").on("click", function () {
    ...
    if ($(window).width() < 768) {
      ...
      $("#menu_9_mobile, .ref_click").on("click", openRefMenu);
      $("#closeRefMobile").on("click", closeRefMenu);
      gsap.to(".menu-Ref-mobile", {
        left: '0',
        top: '-100vh',
        duration: .1,
    ...
    function bottomReset() {
      ...
      gsap.to(".background-layer-4-mobile", {
        top: '0',
        left: '-500px',
        duration: 1.3,
        delay: 0.1,
    ...
    function topReset() {
      ...
      gsap.to(".background-layer-2-mobile", {
        top: '200px',
        left: '-500px',
        duration: 1.3,
        delay: 0.1,
  ...
  //    alert(6);
    ...
    function resetFrame07() {

      gsap
      gsap.killTweensOf("#p-7-1");
      gsap.killTweensOf("#p-7-2");
      gsap.killTweensOf("#p-7-3");
      gsap.killTweensOf("#p-7-4");
      gsap.killTweensOf("#p-7-5");
      gsap.killTweensOf("#p-7-6");
      gsap.killTweensOf("#p-7-7");
    ...
    var render = () => {
        ...
        window.requestAnimationFrame(() => {
            ...
            //console.log(currentPage + ": X " + posX);
            //console.log(currentPage + ": Y " + posY);            
    ...
    window.addEventListener('mousewheel', (e) => {
      ...
      if (this.scrollLeft + e.deltaX < 0 || 
      this.scrollLeft + e.deltaX > maxX || 
      this.scrollTop + e.deltaY < 0 || 
      this.scrollTop + e.deltaY > maxY) {
