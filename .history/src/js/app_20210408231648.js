...
/*  */
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '400px', duration: 2, delay:0.1, ease: "Strong.easeOut"});
  ...
  function moveToScreen01() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '0px', duration: 2, delay:0.1, ease: "Strong.easeInOut"});
