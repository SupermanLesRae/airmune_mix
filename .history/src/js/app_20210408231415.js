...
/*  */
  ...
  function moveToScreen02() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '200px', duration: 1.3, delay:0.1, ease: "Back.easeInOut"});
  ...
  function moveToScreen03() {
    ...
    currentPage=3;
    gsap.to(".page-container", {top: '0', left: '-200%', duration: 1, ease: "Strong.easeOut"});
    gsap.to(".background-layer-2-desktop", {top: '0', left: '400px', duration: 1.3, delay:0.1, ease: "Strong.easeInOut"});
  ...
  function moveToScreen04() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '600px', duration: 1.3, delay:0.1, ease: "Back.easeInOut"});
  ...
  function moveToScreen05() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '0', duration: 1.3, delay:0.1, ease: "Back.easeInOut"});
  ...
  function moveToScreen01() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '0px', duration: 1, delay:0.1, ease: "Strong.easeInOut"});
