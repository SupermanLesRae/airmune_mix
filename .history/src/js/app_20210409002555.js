...
/*  */
  ...
  function moveToScreen04() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '200px', left: '-300px', duration: 2, delay:0.1, ease: "Strong.easeInOut"});
  ...
  function moveToScreen05() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '-300px', duration: 2, delay:0.1, ease: "Strong.easeOut"});
  ...
  function moveToScreen06() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '0px', duration: 2, delay:0.1, ease: "Back.easeOut"});
  ...
  function moveToScreen08() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '-300px', duration: 2, delay:0.1, ease: "Back.easeOut"});
