...
if(!results)
{
    ...
    $("#info-ingre").addClass("absolute");
    $("#info-ingre").removeClass("relative");

    $("#results-ingre").removeClass("absolute");
    $("#info-ingre").addClass("relative");

    $("#results-ingre").addClass("pointer-events-none");

    $("#results-ingre").removeClass("opacity-0");
    $("#results-ingre").removeClass("relative");
    $("#results-ingre").addClass("absolute");
  ...
  $("#results-ingre").addClass("opacity-0");
    ...
    $("#info-ingre").addClass("relative");
    $("#info-ingre").removeClass("absolute");
