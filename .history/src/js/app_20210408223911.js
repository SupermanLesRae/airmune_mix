...
/*  */
  ...
  function moveToScreen02() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-200px', duration: 1, delay:0.5, ease: "Elastic.easeOut"});
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-100px', duration: 1, delay:0.5, ease: "Elastic.easeOut"});
