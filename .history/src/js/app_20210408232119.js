...
/*  */
  ...
  function moveToScreen02() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '150px', duration: 2, delay:0.1, ease: "Back.easeInOut"});
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '300px', duration: 2, delay:0.1, ease: "Back.easeOut"});
  ...
  function moveToScreen01() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-100px', duration: 1, delay:0.1, ease: "Strong.easeInOut"});
