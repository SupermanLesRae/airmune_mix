...
/*  */
  ...
  function moveToScreen07() {
    ...
    currentPage=7;
    $(".page-6").scrollTop(0);
    gsap.to(".page-container", { top: '-100vh', left: '-500%', duration: 3, ease: "Back.easeOut"});

    

    gsap.from("#getOpen img", {left: '110%', opacity:0, duration: .1, delay:1, ease: "Elastic.easeOut" });
