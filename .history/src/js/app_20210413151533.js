...
gsap.to(".menu-get-here", {left:'0', top: '-100vh', duration: .1, ease: "Back.easeOut"});
}



function openGetMenu() {    
  gsap.to(".menu-get-here", {left:'0', top: '0', duration: .5, ease: "Strong.easeOut"});
}

function closeGetMenu() {    
  gsap.to(".menu-get-here", {left:'0', top: '-100vh', duration: .5, ease: "Strong.easeOut"});
}
...
/*  */
  ...
  function landingPageAnimate() {
    ...
    tlanding.from("#airmune-package", {left: "-110vw", duration: 1, rotation:-90, transformOrigin:"center center", ease:"Back.easeOut", delay: 2});
    tlanding.to("#airmune-package", {left: "110vw", duration: 1, rotation:90, transformOrigin:"center center", ease:"Back.easeIn", delay: 6});
...
function bottomReset() {
  gsap.to(".background-layer-4-desktop", {top: '0', left: '-500px', duration: 2, delay:0.1, ease: "Strong.easeOut"});
}

function topReset() {
  gsap.to(".background-layer-2-desktop", {top: '200px', left: '-500px', duration: 2, delay:0.1, ease: "Back.easeInOut"});  
}
...
function moveToScreen01() {
  ...
  gsap.to(".background-layer-2-desktop", {top: '0', left: '0px', duration: 0.2, ease: "Strong.easeInOut"});
  ...
  function moveToScreen02() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '200px', duration: 2, delay:0.1, ease: "Back.easeInOut"});
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '400px', duration: 2, delay:0.1, ease: "Back.easeOut"});
  ...
  function moveToScreen04() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '600px', duration: 2, delay:0.1, ease: "Strong.easeInOut"});

    gsap.to(".background-layer-4-desktop", {top: '200px', left: '-500px', duration: 2, delay:0.1, ease: "Strong.easeInOut"});
  ...
  function moveToScreen06() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '-250px', duration: 2, delay:0.1, ease: "Back.easeOut"});
...
//    gsap.to("#page_5_circle", {right: '0', duration: 0.1, ease: "Elastic.easeInOut"});
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '-100px', duration: 2, delay:0.1, ease: "Back.easeOut"});
    ...
    gsap.from("#getOpen", {top: '100px', opacity:0, duration: .8, delay:0.8, ease: "Strong.easeOut" });
   }
  ...
  function playAni() {
    ...
    gsap.to("#getOpen", {top: '0', opacity:1, duration: .8, delay:0.8, ease: "Back.easeOut",delay:1 });

    gsap.to("#p-7-1", {left: '-0%', opacity:1, duration: .8, ease: "Elastic.easeOut", delay:1.2});
    gsap.to("#p-7-2", {left: '0%', opacity:1, duration: .8, ease: "Elastic.easeOut", delay:1.4});
    gsap.to("#p-7-3", {left: '-0%', opacity:1, duration: .8, ease: "Elastic.easeOut" , delay:1.6});
    gsap.to("#p-7-4", {left: '0%', opacity:1, duration: .8, ease: "Elastic.easeOut", delay:1.8});
    gsap.to("#p-7-5", {left: '-0%', opacity:1, duration: .8, ease: "Elastic.easeOut", delay:2});
    gsap.to("#p-7-6", {left: '0%', opacity:1, duration: .8, ease: "Elastic.easeOut", delay:2.2});
    gsap.to("#p-7-7", {left: '-0%', opacity:1, duration: .8, ease: "Elastic.easeOut", delay:2.4});
  ...
  function moveToScreen08() {
    ...
    gsap.to("#getOpen", {top: '0', opacity:1, duration: .1, ease: "Back.easeOut",delay:3 });
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '0', duration: 2, delay:0.1, ease: "Back.easeOut"});
...
function tracking(e) {
  ...
  if (e.ctrlKey) {
    ...
    if( e.deltaX > 10 )
    {    
      trackpadThisPage("right");
    }
    else if( e.deltaX < -10) {
      trackpadThisPage("left");
    }
    else if( e.deltaY < -10) {
      trackpadThisPage("down");
    }
    else if( e.deltaY < 10) {
      trackpadThisPage("up");
    }
...
function addL() {
  window.addEventListener('wheel', tracking);
    
}


function removeL() {
  window.addEventListener('wheel', tracking, false);
}


function trackpadThisPage(dir) {
...
//gsap.to(".pills", {top: '70%', duration: 1, ease: "Strong.easeOut", delay:0.4});

//gsap.to(".pills", {top: 'auto', duration: 1, ease: "Strong.easeOut", delay:0.4});
