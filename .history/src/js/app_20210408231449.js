...
/*  */
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '400px', duration: 2, delay:0.1, ease: "Strong.easeInOut"});
  ...
  function moveToScreen04() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '600px', duration: 2, delay:0.1, ease: "Back.easeInOut"});
  ...
  function moveToScreen05() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '0', duration: 2, delay:0.1, ease: "Back.easeInOut"});
