...
/*  */
  ...
  function moveToScreen02() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-250px', duration: 1, delay:0.5, ease: "Back.easeInOut"});
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-150px', duration: 1, delay:0.5, ease: "Back.easeInOut"});
  ...
  function moveToScreen04() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '0', duration: 1, delay:0.5, ease: "Back.easeInOut"});
  ...
  function moveToScreen01() {
    ...
    $(".menu-main p").removeClass('font-bold');
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-400px', duration: 1, delay:0.5, ease: "Back.easeInOut"});
