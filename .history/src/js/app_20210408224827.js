...
/*  */
  ...
  function moveToScreen02() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-200px', duration: 1, delay:0.3, ease: "Back.easeInOut"});
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '-50px', duration: 1, delay:0.3, ease: "Back.easeInOut"});
  ...
  function moveToScreen04() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '0', duration: 1, delay:0.3, ease: "Back.easeInOut"});
