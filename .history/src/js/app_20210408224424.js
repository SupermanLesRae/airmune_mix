...
/*  */
  ...
  function moveToScreen03() {
    ...
    gsap.to(".background-layer-2-desktop", {top: '0', left: '100px', duration: 1, delay:0.5, ease: "Back.easeInOut"});
  ...
  function moveToScreen01() {
    ...
    $(".menu-main p").removeClass('font-bold');
    gsap.to(".background-layer-2-desktop", {top: '0', left: '300px', duration: 1, delay:0.5, ease: "Back.easeInOut"});
