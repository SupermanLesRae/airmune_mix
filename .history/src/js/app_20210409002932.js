...
/*  */
  ...
  function moveToScreen06() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '-350px', duration: 2, delay:0.1, ease: "Back.easeOut"});
  ...
  function moveToScreen07() {
    ...
    gsap.to(".background-layer-4-desktop", {top: '0', left: '-150px', duration: 2, delay:0.1, ease: "Back.easeOut"});
