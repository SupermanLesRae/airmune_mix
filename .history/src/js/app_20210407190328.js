...
/*     gsap.to("#animate_1", {left: '0', duration: 1, delay:0.8, ease: "Back.easeOut"}); */
  ...
  function moveToScreen06() {
    ...
    gsap.to("#getOpen", {top: '0', opacity:1, duration: 1, delay:0.8, ease: "Back.easeOut",delay:1 });
  ...
  function playAni() {
    ...
    gsap.to("#getOpen", {top: '100px', opacity:0, duration: .8, delay:0.8, ease: "Back.easeOut",delay:1 });
  ...
  function moveToScreen08() {
    ...
    gsap.from("#getOpen", {top: '100px', opacity:0, duration: .8, delay:0.8, ease: "Back.easeOut",delay:1 });
