...
//    gsap.to("#getOpen", {top: '0', opacity:1, duration: .1, ease: "Back.easeOut" });
  ...
  function playAni() {
    ...
    gsap.from("#getOpen", {top: '100px', opacity:1, duration: .8, delay:0.8, ease: "Back.easeOut",delay:1 });
  ...
  function moveToScreen08() {
    ...
    gsap.from("#getOpen", {top: '100px', opacity:0, duration: .8, delay:0.8, ease: "Back.easeOut",delay:3 });
